// Static imports with aliases (no spaces in variable names)
...
// Map card names to their imported images
 ...
 * @returns The imported image path
 */
export const getCardImagePath = (cardName: string): string => {
  ...
  if (!image) {
    ...
    console.log('Available:', Object.keys(cardImages));
    return '';
  }
